...
_GlobalHint = format["<t align='center' size='2.2' color='#FF0000'>%1<br/></t><t size='1.4' color='#33CCFF'>%2</t><br/>has joined the server, To get involved in the USASOC community, Find a player with official USASOC tags to ask how to join!</t><br/>",_squad,_name];
